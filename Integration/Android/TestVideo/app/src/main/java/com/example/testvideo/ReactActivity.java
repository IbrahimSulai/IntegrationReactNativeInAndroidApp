...
import com.example.testvideo.BuildConfig;
...
public class ReactActivity extends Activity implements DefaultHardwareBackBtnHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mReactRootView.startReactApplication(mReactInstanceManager, "rn57", null);
        mReactRootView.setBackgroundColor(Color.parseColor("#00ffff"));
